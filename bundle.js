...
/* harmony import */ var _models_card_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/card.js */ "./src/models/card.js");
...
class API {
  ...
  getCards() {
    return this._load({url: `tasks`})
      ...
      .then(_models_card_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseCards);
  }
  ...
  createCard(card) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_card_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseCard);
  }
...
class Provider {
  ...
  getCards() {
    ...
    return Promise.resolve(_models_card__WEBPACK_IMPORTED_MODULE_0__["default"].parseCards(storeCards));
  }
  ...
  createCard(card) {
    ...
    const localNewCardId = Object(nanoid__WEBPACK_IMPORTED_MODULE_1__["nanoid"])();
    const localNewCard = _models_card__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(card, {id: localNewCardId}));
  ...
  updateCard(id, card) {
    ...
    const localCard = _models_card__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(card, {id}));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CardEdit; });
...
const createCardEditTemplate = (options = {}) => {
  ...
  const description = Object(he__WEBPACK_IMPORTED_MODULE_3__["encode"])(currentDescription);
  ...
  (isRepeatingCard && !Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["isRepeating"])(activeRepeatingDays)) ||
...
class CardEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(card) {
    super();
  ...
  _applyFlatpickr() {
    ...
    if (this._isDateShowing) {
      ...
      this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(dateElement, {
        altInput: true,
        altFormat: `j F H:i`,
...
class Card extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(card) {
    super();
...
class Cards extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class NoCards extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(message) {
    super();
...
const createSortingTemplate = () => {
  return (
    `<div class="board__filter-list">
      <a href="#" class="board__filter" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}">SORT BY DEFAULT</a>
      <a href="#" class="board__filter" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE_UP}">SORT BY DATE up</a>
      <a href="#" class="board__filter" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE_DOWN}">SORT BY DATE down</a>
    </div>`
  );
};
...
const getCardsByDateRange = (cards, dateFrom, dateTo) => {
  return cards.filter((card) => {
    const dueDate = card.dueDate;

    return dueDate >= dateFrom && dueDate <= Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["setEndDate"])(dateTo);
  });
};
...
const calcUniqCountColor = (cards, color) => {
...
const renderColorsChart = (colorsCtx, cards, dateFrom, dateTo) => {
  const chosenDatesCards = getCardsByDateRange(cards, dateFrom, Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["setEndDate"])(dateTo));
  const colors = chosenDatesCards
    .map((card) => card.color)
    .filter(getUniqItems);
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(colorsCtx, {
    ...
    data: {
      labels: colors,
      datasets: [{
        data: colors.map((color) => calcUniqCountColor(chosenDatesCards, color)),
      ...
      tooltips: {
        callbacks: {
          label: (tooltipItem, data) => {
            ...
            return `${tooltipData} ${tooltipData === 1 ? `TASK` : `TASKS`} — ${tooltipPercentage}%`;
          }
        },
        displayColors: false,
...
const renderDaysChart = (daysCtx, cards, dateFrom, dateTo) => {
  const days = calculateBetweenDates(dateFrom, Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["setEndDate"])(dateTo));

  const cardCountOnDay = days.map((date) => {
    return cards.filter((card) => {
      return Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["isOneDay"])(card.dueDate, date);
    }).length;
  });

  const formattedDates = days.map((day) => moment__WEBPACK_IMPORTED_MODULE_4___default()(day).format(`DD MMM`));
...
const createStatisticsTemplate = ({cards, dateFrom, dateTo}) => {
  ...
  const cardsCount = getCardsByDateRange(cards, dateFrom, dateTo).length;
      ...
      <div class="statistic__line">
        <div class="statistic__period">
          ...
          <p class="statistic__period-result">
            ...
            <span class="statistic__task-found">${cardsCount}</span> ${cardsCount === 1 ? `task was` : `tasks were`} fulfilled.
          </p>
        </div>
...
class Statistics extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor({cards, dateFrom, dateTo}) {
    super();
  ...
  getTemplate() {
    return createStatisticsTemplate({cards: this._cards.getStatsCards(), dateFrom: this._dateFrom, dateTo: this._dateTo});
  }

  show() {
    super.show();
    this.rerender(this._cards, this._dateFrom, this._dateTo);
  }

  recoveryListeners() {}

  rerender(cards, dateFrom, dateTo) {
    this._cards = cards;
    this._dateFrom = dateFrom;
    this._dateTo = dateTo;
  ...
  _renderCharts() {
    ...
    this._daysChart = renderDaysChart(daysCtx, this._cards.getStatsCards(), this._dateFrom, this._dateTo);
    this._colorsChart = renderColorsChart(colorsCtx, this._cards.getStatsCards(), this._dateFrom, this._dateTo);
  }
  ...
  _applyFlatpickr(element) {
    ...
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_5___default()(element, {
      ...
      onChange: (dates) => {
        if (dates.length === 2) {
          this.rerender(this._cards, dates[0], dates[1]);
        }
      }
    });
  }
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: Color, COLORS, DAYS, EmptyCard, FilterType, MenuItem, Message, Mode, SortType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmptyCard", function() { return EmptyCard; });
...
/* harmony import */ var _components_cards_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/cards.js */ "./src/components/cards.js");
/* harmony import */ var _card_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./card.js */ "./src/controllers/card.js");
...
/* harmony import */ var _components_no_cards_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/no-cards.js */ "./src/components/no-cards.js");
...
const renderCards = (cardListElement, cards, onDataChange, onViewChange) => {
  return cards.map((card) => {
    const cardController = new _card_js__WEBPACK_IMPORTED_MODULE_1__["default"](cardListElement, onDataChange, onViewChange);
    cardController.render(card, _const_js__WEBPACK_IMPORTED_MODULE_6__["Mode"].DEFAULT);
...
const getSortedCards = (cards, sortType, from, to) => {
  ...
  switch (sortType) {
    case _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].DATE_UP:
      sortedCards = showingCards.sort((a, b) => a.dueDate - b.dueDate);
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].DATE_DOWN:
      sortedCards = showingCards.sort((a, b) => b.dueDate - a.dueDate);
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].DEFAULT:
...
class BoardController {
  constructor(container, cardsModel, api) {
    ...
    this._sortComponent = new _components_sort_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._cardsComponent = new _components_cards_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
  ...
  render() {
    ...
    if (cardsToShow.length === 0) {
      this._noCardsComponent = new _components_no_cards_js__WEBPACK_IMPORTED_MODULE_3__["default"](_const_js__WEBPACK_IMPORTED_MODULE_6__["Message"].NO_CARDS);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._noCardsComponent);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._sortComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._cardsComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._noCardsComponent);
  ...
  showLoadingMessage() {
    this._noCardsComponent = new _components_no_cards_js__WEBPACK_IMPORTED_MODULE_3__["default"](_const_js__WEBPACK_IMPORTED_MODULE_6__["Message"].LOADING);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container.getElement(), this._noCardsComponent);
  }
  ...
  createCard() {
    ...
    this._creatingCard = new _card_js__WEBPACK_IMPORTED_MODULE_1__["default"](cardListElement, this._onDataChange, this._onViewChange);
    this._creatingCard.render(_const_js__WEBPACK_IMPORTED_MODULE_6__["EmptyCard"], _const_js__WEBPACK_IMPORTED_MODULE_6__["Mode"].ADDING);
  }
  ...
  resetToDefault() {
    ...
    this._onSortTypeChange(_const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].DEFAULT);
  }
  ...
  _renderLoadMoreButton() {
    ...
    const container = this._container.getElement();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._loadMoreButtonComponent);
  ...
  _onDataChange(cardController, oldData, newData) {
    if (oldData === _const_js__WEBPACK_IMPORTED_MODULE_6__["EmptyCard"]) {
      this._creatingCard = null;
      if (newData === null) {
        ...
        this._api.createCard(newData)
          .then((cardModel) => {
            ...
            cardController.render(cardModel, _const_js__WEBPACK_IMPORTED_MODULE_6__["Mode"].DEFAULT);
...
/* harmony import */ var _components_card_edit_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/card-edit.js */ "./src/components/card-edit.js");
/* harmony import */ var _models_card_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/card.js */ "./src/models/card.js");
...
const parseFormData = (formData) => {
  ...
  const repeatingDays = _const_js__WEBPACK_IMPORTED_MODULE_3__["DAYS"].reduce((acc, day) => {
    acc[day] = false;
    return acc;
  }, {});

  return new _models_card_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
...
class CardController {
  constructor(container, onDataChange, onViewChange) {
    ...
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].DEFAULT;
  ...
  render(card, mode) {
    ...
    this._cardComponent = new _components_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](card);
    this._cardEditComponent = new _components_card_edit_js__WEBPACK_IMPORTED_MODULE_1__["default"](card);
    ...
    this._cardComponent.setArchiveButtonClickHandler(() => {
      const newCard = _models_card_js__WEBPACK_IMPORTED_MODULE_2__["default"].clone(card);
    ...
    switch (mode) {
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].DEFAULT:
        if (oldCardEditComponent && oldCardComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._cardComponent, oldCardComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._cardEditComponent, oldCardEditComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(oldCardComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(oldCardEditComponent);
          this._replaceEditToCard();
        } else {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container, this._cardComponent);
        }
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].ADDING:
        this._onViewChange();
        if (oldCardEditComponent && oldCardComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(oldCardComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(oldCardEditComponent);
        ...
        document.addEventListener(`keydown`, this._onEscKeyDown);
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container, this._cardEditComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].AFTERBEGIN);
        break;
    }
  }

  setDefaultView() {
    if (this._mode !== _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].DEFAULT) {
      this._replaceEditToCard();
    }
  }
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._cardEditComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._cardComponent);
    document.removeEventListener(`keydown`, this._onEscKeyDown);
  }

  _onEscKeyDown(evt) {
    if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["isEscEvent"])(evt)) {
      if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].ADDING) {
        this._onDataChange(this, _const_js__WEBPACK_IMPORTED_MODULE_3__["EmptyCard"], null);
      }
      this._replaceEditToCard();
      document.removeEventListener(`keydown`, this._onEscKeyDown);
    }
  ...
  _replaceCardToEdit() {
    this._onViewChange();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._cardEditComponent, this._cardComponent);
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDIT;
  }
  ...
  _replaceEditToCard() {
    ...
    if (document.contains(this._cardEditComponent.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._cardComponent, this._cardEditComponent);
    }
...
class FilterController {
  ...
  render() {
    ...
    const filters = Object.values(_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
        count: Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["getCardsByFilter"])(allCards, filterType).length,
    ...
    if (oldComponent) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(container, this._filterComponent);
    }
  }
...
/* harmony import */ var _models_cards_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/cards.js */ "./src/models/cards.js");
/* harmony import */ var _controllers_filter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/filter.js */ "./src/controllers/filter.js");
...
/* harmony import */ var _api_provider_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./api/provider.js */ "./src/api/provider.js");
/* harmony import */ var _components_statistics_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/statistics.js */ "./src/components/statistics.js");
/* harmony import */ var _api_store_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./api/store.js */ "./src/api/store.js");
...
const dateTo = (() => {
  const date = new Date();
  Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_11__["setEndDate"])(date);
  return date;
})();
...
const api = new _api_index_js__WEBPACK_IMPORTED_MODULE_0__["default"](END_POINT, AUTHORIZATION);
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_8__["default"](STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_6__["default"](api, store);

const cardsModel = new _models_cards_js__WEBPACK_IMPORTED_MODULE_3__["default"]();

const siteMainElement = document.querySelector(`.main`);
const siteHeaderElement = siteMainElement.querySelector(`.main__control`);

const menuComponent = new _components_menu_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
const statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_7__["default"]({cards: cardsModel, dateFrom, dateTo});
const boardComponent = new _components_board_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const boardController = new _controllers_board_js__WEBPACK_IMPORTED_MODULE_2__["default"](boardComponent, cardsModel, apiWithProvider);
const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_4__["default"](siteMainElement, cardsModel);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteHeaderElement, menuComponent);
filterController.render();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMainElement, boardComponent);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMainElement, statisticsComponent);
statisticsComponent.hide();
boardController.showLoadingMessage();

menuComponent.setOnChange((menuItem) => {
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].NEW_CARD:
      menuComponent.setActiveItem(_const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].CARDS);
      statisticsComponent.hide();
      boardController.show();
      boardController.createCard();
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].STATISTICS:
...
class Cards {
  ...
  getStatsCards() {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["getCardsByFilter"])(this._cards, _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ARCHIVE);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: formatDate, formatTime, isEscEvent, isOneDay, isOverdueDate, isRepeating, setEndDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const formatDate = (date) => moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`D MMMM`);

const formatTime = (date) => moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`HH:mm`);
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getArchiveCards, getNotArchiveCards, getFavoriteCards, getOverdueCards, getRepeatingCards, getCardsInOneDay, getCardsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getArchiveCards", function() { return getArchiveCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNotArchiveCards", function() { return getNotArchiveCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFavoriteCards", function() { return getFavoriteCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOverdueCards", function() { return getOverdueCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRepeatingCards", function() { return getRepeatingCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCardsInOneDay", function() { return getCardsInOneDay; });
...
const getRepeatingCards = (cards) => {
  return cards.filter((card) => Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["isRepeating"])(card.repeatingDays));
};

const getCardsInOneDay = (cards, date) => {
  return cards.filter((card) => Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["isOneDay"])(card.dueDate, date));
};
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: RenderPosition, createElement, remove, render, replace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
